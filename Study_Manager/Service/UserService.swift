...
protocol UserServiceProtocol {
    ...
    func updateUserMe(token: String, username: String, password: String, email: String, phoneNumber: Int, age: String, school: String, completion: @escaping (ServerResponse<User>) -> Void)
