...
protocol AuthServiceProtocol {
    ...
    func register(username: String, password: String, email: String, phoneNumber: String, age: String, school: String, completion: @escaping (ServerResponse<AuthResponse>) -> Void)
}
